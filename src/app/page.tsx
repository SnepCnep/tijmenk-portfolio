...
export default function Home() {
  return (
    <main className="snap-y snap-mandatory h-screen overflow-y-scroll scroll-smooth bg-background text-foreground">
      {/* Navbar */}
      <Navbar />
      ...
      <section
        id="intro"
        className="snap-start flex flex-col items-center justify-center h-screen bg-gradient-to-b from-gray-800 to-gray-900 text-center"
      >
      ...
      <section
        id="about"
        className="snap-start flex flex-col items-center justify-center h-screen bg-gradient-to-b from-gray-900 to-black text-center"
      >
      ...
      <section
        id="projects"
        className="snap-start flex flex-col items-center justify-center h-screen bg-gradient-to-b from-black to-gray-800 text-center"
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10 max-w-4xl mx-auto">
          <Card className="p-6 bg-card border border-border">
            <h4 className="text-xl font-bold text-card-foreground">Project 1</h4>
            <p className="mt-2 text-muted-foreground">
              A brief description of your amazing project.
            </p>
          </Card>
          <Card className="p-6 bg-card border border-border">
            <h4 className="text-xl font-bold text-card-foreground">Project 2</h4>
            <p className="mt-2 text-muted-foreground">
              Another brief description of an awesome project.
            </p>
          </Card>
          <Card className="p-6 bg-card border border-border">
            <h4 className="text-xl font-bold text-card-foreground">Project 3</h4>
            <p className="mt-2 text-muted-foreground">
